...
/*
curry is a command line tool for querying currency rates, which are provided by OpenExchangeRates.

Disclaimer

Like OpenExchangeRates themselves, exchange rates are provided for informational purposes only and do not constitute financial advice of any kind. Although every attempt is made to ensure quality, no guarantees are made of accuracy, validity, availability, or fitness for any purpose.
...
Copyright 2016 Michael Chen.  All rights reserved. The app is licensed under GPLv3.
*/
package main
